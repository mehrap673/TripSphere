      ...
      <div class="relative z-10 min-h-screen flex items-center justify-center px-4 py-12">
        <div class="w-full max-w-md">
          ...
          <div class="text-center mb-8 animate-scale-in">
            ...
            <h1 class="text-4xl font-bold text-white mb-3 drop-shadow-lg animate-fade-up">Welcome Back</h1>
            <p class="text-lg text-white/90 drop-shadow-md animate-fade-up" style="animation-delay: 0.1s">Login to explore amazing destinations</p>
          </div>
          ...
          <div class="backdrop-blur-2xl bg-white/10 dark:bg-white/5 rounded-3xl shadow-2xl border-2 border-white/20 p-8 animate-slide-up" style="animation-delay: 0.2s">
            ...
            <div class="relative my-6">
              ...
              <div class="relative flex justify-center">
                <span class="px-4 bg-white/10 backdrop-blur-xl text-white font-medium rounded-full">Or continue with</span>
              </div>
            </div>

            <!-- Demo Credentials Card -->
            <div class="mb-5 p-4 bg-white/10 backdrop-blur-xl border-2 border-white/20 rounded-xl animate-fade-up" style="animation-delay: 0.3s">
              <div class="flex items-start">
                <svg class="w-5 h-5 text-white/80 mr-3 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                </svg>
                <div>
                  <p class="text-white/90 text-sm font-medium mb-2">Quick Test Login</p>
                  <div class="space-y-1 text-xs text-white/80">
                   <p>📧 <span class="font-mono bg-white/10 px-2 py-0.5 rounded">john&#64;example.com</span></p>
                    <p>🔑 <span class="font-mono bg-white/10 px-2 py-0.5 rounded">password123</span></p>
                  </div>
                  <p class="text-white/70 text-xs mt-2">Or create your own account below</p>
                </div>
              </div>
            </div>
            ...
            <form (ngSubmit)="onSubmit()" class="space-y-5">
              ...
              <div class="flex items-center">
                <input id="remember-me" 
                       ...
                       type="checkbox"
                       [(ngModel)]="rememberMe"
                       class="h-4 w-4 rounded border-white/30 bg-white/20 text-white focus:ring-white/50">
                <label for="remember-me" class="ml-2 text-white text-sm font-medium">
          ...
          <p class="mt-6 text-center text-white/90 backdrop-blur-sm bg-white/10 rounded-full py-3 px-6 inline-block animate-fade-up" style="animation-delay: 0.4s">
            ...
            <a routerLink="/register" class="font-bold hover:underline ml-1">
              Create one
            </a>
          </p>
        </div>
